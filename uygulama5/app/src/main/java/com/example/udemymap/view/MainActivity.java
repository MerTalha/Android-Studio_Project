...
import com.example.udemymap.adapter.PlaceAdapter;
import com.example.udemymap.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //placeDao.getAll().subscribeOn(Schedulers.io()).subscribe(MainActivity.this::handleResponse);
